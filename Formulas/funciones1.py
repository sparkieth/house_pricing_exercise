...
ordinal_col = {'BsmtQual':cat1, 'BsmtCond':cat1, 'ExterQual':cat1, 'ExterCond':cat1, 'KitchenQual':cat1,
               'PavedDrive':cat2, 'Electrical':cat3,  'BsmtFinType1':cat4, 'BsmtFinType2':cat4, 'Utilities':cat5,'MSZoning':cat6,'Foundation':cat7, 'Neighborhood':cat8,
              'MasVnrType':cat9,'SaleCondition':cat10,'RoofStyle':cat11,'RoofMatl':cat12}
